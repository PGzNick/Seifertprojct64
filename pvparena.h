...
{
	public:
		PvpArena(uint8_t _id, const Position& _bluRspawn, const Position& _redSpawn, const Position& _exit, uint32_t _maxLevel, uint16_t _blueChannel, uint16_t _redChannel);
		virtual ~PvpArena();
