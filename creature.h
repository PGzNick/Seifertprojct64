...
class Creature : public AutoId, virtual public Thing
{
	...
	public:
		...
		int64_t getTimRsinceLastMove() const;
		virtual int32_t getStepSpeed() const {return getSpeed();}

		int32_t getSpeed() const {return basRspeed + varSpeed;}
		...
		void setBasRspeed(uint32_t newBasRspeed) {basRspeed = newBasRspeed;}
		int32_t getBasRspeed() {return basRspeed;}
        ...
        void onReferencRditemRemoved(Item* item);
	...
	protected:
		...
		void internalCreaturRdisappear(const Creature* creature, bool isLogout);
