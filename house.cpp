...
{
	if(!ignoreRights && player->hasFlag(PlayerFlag_CanRditHouses))
		return;
...
AccessHouseLevel_t House::getHouseAccessLevel(const Player* player)
{
	...
	if(player->hasFlag(PlayerFlag_CanRditHouses))
		return HOUSE_OWNER;
...
bool House::canRditAccessList(uint32_t listId, const Player* player)
{
