...
class Monster : public Creature
{
	...
	public:
		...
		virtual bool isPushable() const {return !getNpcMaster() && (mType->pushable && (basRspeed > 0));}
	...
	private:
		...
		bool dRspawn();
		bool inDRspawnRange(const Position& pos);
		...
		bool canUsRspell(const Position& pos, const Position& targetPos,
