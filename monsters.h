...
class MonsterType
{
	public:
        ...
        int16_t sex;
		int32_t defense, armor, health, healthMax, basRspeed, lookCorpse, corpseUnique, corpseAction,
...
class Monsters
{
	...
	private:
		...
		bool deserializRspell(xmlNodePtr node, spellBlock_t& sb, const std::string& description = "");
