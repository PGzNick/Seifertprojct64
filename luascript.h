...
class LuaScriptInterface
{
	...
	protected:
		...
		static int32_t luaGetCreaturRspeakType(lua_State* L);
		...
		static int32_t luaDoRemovRipBanishment(lua_State* L);
		...
		static int32_t luaGetCreaturRspeed(lua_State* L);
		static int32_t luaGetCreatureBasRspeed(lua_State* L);
		...
		static int32_t luaGetPlayerLearnRdinstantSpell(lua_State* L);
		...
		static int32_t luaDoChangRspeed(lua_State* L);
        ...
        static int32_t luaSetCreatureBasRspeed(lua_State* L);
        ...
        static int32_t luaDoCreaturRdie(lua_State* L);
